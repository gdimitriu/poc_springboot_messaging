 ...
 */
package poc.springboot.messaging.businessapps.producer;
...
/**
 * Service to send a payload to a queue.
 * @author  Gabriel Dimitriu
 */
@Service
public class PayloadProducer {

    private static Logger log = LoggerFactory.getLogger(PayloadProducer.class);

    @Autowired
    private JmsTemplate jmsTemplate;

    public void send(String queueName, MyPayload payload) {
        log.info("sending with convertAndSend to " + queueName + "<" + payload + ">");
